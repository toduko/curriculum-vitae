...
\begin{itemize}
  \item Achieved \textbf{5.76/6.00} overall GPA and scored \textbf{6.00/6.00} on the State Examination.
\end{itemize}

\textbf{M.Sc. in Logic and Algorithms, Sofia University “St. Kliment Ohridski”} \hspace*{\fill} \textit{10/2025 (Ongoing)}
...
\begin{itemize}
  ...
  \item \textbf{Logic Programming} (2 semesters):  
...
\textbf{Junior Software Engineer, MBition} \hspace*{\fill} \textit{01/2025 -- 02/2026}
\begin{itemize}
